...
{
    internal class BooleanHandler : Natural.Xml.ITagHandler
    {
        #region Base
        ...
        public BooleanHandler(RawXmlReferenceTracking tracking, Dictionary<string, object> data, string jsonName)
        {
            m_tracking = tracking;
            m_parentData = data;
            m_jsonName = jsonName;
